...
func TestGenSite(t *testing.T) {
	...
	path := "testResources/deploy/blog/2018/1/13/a-little-test/index.html"
	expected := getExpectedPageHtml()
	actual := fs.ReadFileAsString(path)

	if expected != actual {
		t.Error("Generated HTML not as expected:", gohtml.Format(actual))
	}
...
func getExpectedPageHtml() string {
	return `<!doctype html><html><head><meta viewport="width=device-width, initial-scale=1.0"/><meta content="no" http-equiv="imagetoolbar"/><meta robots="index,follow"/><meta author="Ingmar Drewing"/><meta publisher="Ingmar Drewing"/><meta keywords="storytelling, illustration, drawing, web comic, comic, cartoon, caricatures"/><meta dc.subject="storytelling, illustration, drawing, web comic, comic, cartoon, caricatures"/><meta page-topic="art"/><meta content="en" http-equiv="Language"/><meta content="en" http-equiv="Content-Language"/><meta content="Private" http-equiv="cache-control"/><meta content="Private" http-equiv="pragma"/><meta content="0" http-equiv="expires"/><meta charset="UTF-8"/><meta content="text/html;charset=UTF-8" http-equiv="content-type"/><link href="/icons/favicon-16x16.png" rel="icon" sizes="16x16" type="image/png"/><link href="/icons/favicon-32x32.png" rel="icon" sizes="32x32" type="image/png"/><link href="/icons/android-192x192.png" rel="icon" sizes="192x192" type="image/png"/><link href="/icons/apple-touch-icon-180x180.png" rel="apple-touch-icon" sizes="180x180" type="image/png"/><meta content="/icons/browserconfig.xml" name="msapplication-config"/><meta content="A Little Test" itemprop="name"/><meta content=" " itemprop="description"/><meta content="https://drewingde.s3.us-west-1.amazonaws.com/blog/2018/1/13/ALittleTest-w800.png" itemprop="image"/><meta content="summary_large_image" name="t:card"/><meta content="@ingmardrewing" name="t:site"/><meta content="A Little Test" name="t:title"/><meta content=" " name="t:text:description"/><meta content="@ingmardrewing" name="t:creator"/><meta content="https://drewingde.s3.us-west-1.amazonaws.com/blog/2018/1/13/ALittleTest-w800.png" name="t:image"/><meta content="A Little Test" property="og:title"/><meta content="blog/2018/1/13/a-little-test/index.html" property="og:url"/><meta content="https://drewingde.s3.us-west-1.amazonaws.com/blog/2018/1/13/ALittleTest-w800.png" property="og:image"/><meta content=" " property="og:description"/><meta content="" property="og:site_name"/><meta content="article" property="og:type"/><meta content="2018-1-7 1:50:42" property="article:published_time"/><meta content="2018-1-7 1:50:42" property="article:modified_time"/><meta content="Illustration" property="article:section"/><meta content="comic, graphic novel, webcomic, science-fiction, sci-fi" property="article:tag"/><link href="styles.css" rel="stylesheet" type="text/css"/><title>A Little Test</title></head><body><div class="wrapperOuter "><div class="wrapperInner"><main class="maincontent"><h1 class="maincontent__h1">A Little Test</h1><h2 class="maincontent__h2">2018-1-7 1:50:42</h2><p><a href="https://drewingde.s3.us-west-1.amazonaws.com/blog/2018/1/13/ALittleTest.png"><img src="https://drewingde.s3.us-west-1.amazonaws.com/blog/2018/1/13/ALittleTest-w800.png" alt=""/></a></p></main></div></div><div class="wrapperOuter "><div class="wrapperInner"><div class="disqus" id="disqus_thread"> </div></div></div><script language="javascript" type="text/javascript">var disqus_config = function () { this.page.title= "A Little Test"; this.page.url = 'https://drewing.deblog/2018/1/13/a-little-test/index.html'; this.page.identifier =  'drewing.de 2018/1/13/A Little Test'; }; (function() { var d = document, s = d.createElement('script'); s.src = 'https://drewing.disqus.com/embed.js'; s.setAttribute('data-timestamp', +new Date()); (d.head || d.body).appendChild(s); })();</script><div class="wrapperOuter headerbar__wrapper"><div class="wrapperInner"><header class="headerbar"><div class="headerbar__logocontainer"><a class="headerbar__logo" href="https://drewing.de"><!-- logo --></a></div></header></div></div><div class="wrapperOuter mainnavi__wrapper"><div class="wrapperInner"><div class=""><nav class="mainnavi"><a class="mainnavi__navelement" href="testResources/deploy/blog/index.html">Blog</a><a class="mainnavi__navelement" href="https://www.facebook.com/drewing.de">Facebook</a><a class="mainnavi__navelement" href="https://twitter.com/ingmardrewing">Twitter</a></nav></div></div></div><div class="wrapperOuter "><div class="wrapperInner"><div class="copyright"><a rel="license" class="copyright__cc" href="https://creativecommons.org/licenses/by-nc-nd/3.0/"></a><p class="copyright__license">© 2017 by Ingmar Drewing </p><p class="copyright__license">Except where otherwise noted, content on this site is licensed under a <a rel="license" href="https://creativecommons.org/licenses/by-nc-nd/3.0/">Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported (CC BY-NC-ND 3.0) license</a>.</p><p class="copyright__license">Soweit nicht anders explizit ausgewiesen, stehen die Inhalte auf dieser Website unter der <a rel="license" href="https://creativecommons.org/licenses/by-nc-nd/3.0/">Creative Commons Namensnennung-NichtKommerziell-KeineBearbeitung (CC BY-NC-ND 3.0)</a> Lizenz. Unless otherwise noted the author of the content on this page is <a href="https://plus.google.com/113943655600557711368?rel=author">Ingmar Drewing</a></p></div></div></div><div class="wrapperOuter footernavi__wrapper"><div class="wrapperInner"><div class=""><nav class="footernavi"><a class="footernavi__navelement" href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fwww.drewing.de%2Fblog&amp;t=drewing.de">Share on Facebook</a><a class="footernavi__navelement" href="mailto:blank?subject=I found this on drewing.de&amp;body=I thought you might be interested in this blogpost: https://www.drewing.de/blog/ingmars-booklist/">Tell a friend</a><a class="footernavi__navelement" href="/blog/about.html">Me</a><a class="footernavi__navelement" href="/blog/booklist.html">booklist</a><a class="footernavi__navelement" href="/blog/imprint.html">imprint</a></nav></div></div></div></body></html>`
}
